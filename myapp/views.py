...
def get_query(request):
    ...
    <p>Colors: {request.GET.getlist("color")}</p>
...
def form_example(request):
    ...
    if request.GET:
        ...
        # kleines get hier als Dict Methode um key und values auszulesen
        name = request.GET.get("vorname", "Unbekannt")
        stadt = request.GET.get("stadt", "Buxdehude")
